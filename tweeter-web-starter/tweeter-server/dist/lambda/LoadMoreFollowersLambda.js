...
let handler = (event) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    event = tweeter_shared_1.LoadMoreUserItemsRequest.fromJson(event);
    ...
    return yield (0, IntegrationResponseCommon_1.performErrorReportingOperation)(() => __awaiter(void 0, void 0, void 0, function* () {
        return new tweeter_shared_1.LoadMoreUserItemsResponse(true, ...(yield new FollowService_1.FollowService().loadMoreFollowers(event.authToken, event.user, event.pageSize, event.lastItem)));
    }));
});
