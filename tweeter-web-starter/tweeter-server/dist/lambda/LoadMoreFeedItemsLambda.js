...
let handler = (event) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return yield (0, IntegrationResponseCommon_1.performErrorReportingOperation)(() => __awaiter(void 0, void 0, void 0, function* () {
        return new tweeter_shared_1.LoadMoreStatusItemsResponse(true, ...(yield new StatusService_1.StatusService().loadMoreFeedItems(event.authToken, event.user, event.pageSize, !!event.lastItem ? tweeter_shared_1.Status.fromJson(JSON.stringify(event.lastItem)) : null)));
    }));
});
