...
const Register = () => {
    ...
    return (
        <AuthenticationFormLayout
            ...
            submitButtonDisabled={() => presenter.checkSubmitButtonStatus(firstName, lastName, alias, password)}
            submit={() => presenter.doRegister(firstName, lastName, alias, password, imageBytes)}
        />
    );
};
